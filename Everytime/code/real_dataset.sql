...
INSERT INTO contents VALUES(NULL, 8, '캬 형 랩 미쳣다 ㅋㅋㅋㅋ', 'ㅋㅋㅋㅋㄲ', '2024-11-20 13:45', '1', 24, 1, 16, 12, 1);
INSERT INTO contents VALUES(NULL, 8, '앵 콜', '앵 콜', '2024-11-20 13:47', '1', 2, 0, 7, 12, 1);
INSERT INTO contents VALUES(NULL, 8, '드론 픽앤플레이스 잘 되나요?', '하ㅋㅋㅋㅋㅋ', '2024-11-20 16:44', '1', 0, 0, 1, 11, 0);
INSERT INTO contents VALUES(NULL, 8, '컴네 ta 미팅', '몇 분 정도 하나요?', '2024-11-20 20:13', '1', 0, 0, 5, 10, 1);
INSERT INTO contents VALUES(NULL, 8, '2학년인데 팀플때문에 죽겠어요', '데베 알고리즘 네트워크 무슨 팀플 3개를 한번에,,, 근데 기말 공부도 해야 해... 랩테도 준비해야 해... 이걸 다들 어떻게 하고 계신겁니까,,, 하루가 너무 부족해요.. 실력도 없는 것 같고 팀원들에게 폐끼치는 거 아닌가 속상해요 .. 제가 너무 작아진 것 같아요 ㅠㅠㅠ', '2024-11-20 21:12', '1', 6, 1, 13, 10, 1);
INSERT INTO contents VALUES(NULL, 8, '미스터 로봇 개꿀잼', '꼭봐라', '2024-11-20 21:57', '1', 0, 0, 0, 7, 1);
INSERT INTO contents VALUES(NULL, 8, '취창업 과제', '취창업 발표영상 올리는 과제 필수 아닌 거 맞나요?', '2024-11-20 21:57', '1', 0, 0, 0, 8, 1);
INSERT INTO contents VALUES(NULL, 8, '내일 드론 수업 때 완성 못 하면', '어떡하지...', '2024-11-20 23:07', '1', 0, 0, 0, 6, 1);
INSERT INTO contents VALUES(NULL, 8, '다죽자', '다죽자~~~ 일단 난 죽겠음', '2024-11-21 00:14', '1', 0, 0, 1, 5, 1);
INSERT INTO contents VALUES(NULL, 8, '안녕하세요 내년에 소웨 2학년 군복학생입니다', '하고싶은 프로젝트하면서 프레임워크 다뤄보면서 이것저것 하고있는데요, 하면서 느끼는게 전공지식이 진짜 중요하겠구나 입니다...혹시 2 3학년때 배우는 중요한 cs지식들 다 c기반으로 할까요...! 핑프라 죄송함돠!!!!', '2024-11-21 02:25', '1', 0, 0, 7, 4, 1);
INSERT INTO contents VALUES(NULL, 12, 'ㅇㅅㅎ 웹db', '전범위인지 중간 이후부터인지 아는사람...', '2024-11-21 03:07', '1', 0, 0, 0, 6, 1);
INSERT INTO contents VALUES(NULL, 12, 'ㅅㅅㅈ 자바 과제', '이거 jsp파일들이 어느디렉토리에 있는거야?', '2024-11-21 09:13', '1', 0, 0, 0, 5, 1);
INSERT INTO contents VALUES(NULL, 12, '코딩애플 유료수강 해보신분들 계신가요', '어떤가요 후기 알려주세요!', '2024-11-21 09:34', '1', 0, 0, 3, 9, 1);
INSERT INTO contents VALUES(NULL, 8, '컴구 점수 떴다 rr', '분포 레전드 ㅋㅋ', '2024-11-21 13:36', '1', 0, 0, 4, 3, 1);
INSERT INTO contents VALUES(NULL, 8, '알고 점수떴네', '다들 잘봄?? 평균 몇이려나', '2024-11-21 17:31', '1', 0, 0, 0, 2, 1);
INSERT INTO contents VALUES(NULL, 12, 'ㅇㅂㅎ 구현 다 못한사람있음?', '??', '2024-11-21 17:59', '1', 0, 0, 5, 15, 1);
INSERT INTO contents VALUES(NULL, 8, '슬슬', '다들 연구실 알아보는거 같은데.. 나도 알아봐야겠다', '2024-11-21 20:50', '1', 0, 0, 7, 1, 1);
INSERT INTO contents VALUES(NULL, 12, '카엔프', '방학에 기업나가서 실습하는거 필수인가요 선배님들', '2024-11-21 20:51', '1', 0, 0, 1, 14, 1);
INSERT INTO contents VALUES(NULL, 12, 'p프', '다음주부터 시작인데 논술보는데 아무런 공지가없네ㅜ', '2024-11-22 00:52', '1', 0, 0, 0, 13, 1);
INSERT INTO contents VALUES(NULL, 6, '대학원 권유', '어떤식으로 받음? 교수님하고 부딪힐 일이 있나? 그냥 수업하고 땡 수업하고 땡 시험보고 땡 이런식인데? 시험을 잘봐서 제안이 오는거야?', '2024-11-22 19:22', '0', 0, 0, 0, 9, 1);
...
INSERT INTO CourseEvaluation (evaluation_id, course_id, evaluator_id, semester, rating, content, recommend_count, not_recommend_count, assignment_amount, group_meeting_frequency, grading_flexibility) 
VALUES (4, '14466_006', 202302, '2023-2학기', 3, '수업 내용은 좋았지만 과제 난이도가 너무 높았습니다.', 8, 3, '많음', '보통', '보통');
